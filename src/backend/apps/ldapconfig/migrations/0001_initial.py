            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=253,
                        unique=True,
                        validators=[helpers.validators.model_validators.validate_host_ip],
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=255,
                        unique=True,
                        validators=[helpers.validators.model_validators.validate_dn],
                    ),
                ),
                (
                    "scope",
                    models.CharField(
                        choices=[("OL", "One Level"), ("SB", "Subtree")],
                        default="OL",
                        max_length=2,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="group_ldapconfig_set", to="ldapconfig.ldapdn"
                    ),
                ),
                (
                    "groups_pool",
